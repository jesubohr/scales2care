...
export const hasbledResults = {
  results: [
    ...
    },
    {
      min: 1,
      max: 1,
      result: "1,3% de riesgo.",
    },
    {
      min: 2,
      max: 2,
      result: "2,2% de riesgo.",
    },
    {
      min: 3,
      max: 3,
      result: "3,2% de riesgo.",
    },
    {
      min: 4,
      max: 4,
      result: "4,0% de riesgo.",
    },
    {
      min: 5,
      max: 5,
      result: "6,7% de riesgo.",
    },
    {
      min: 6,
      max: 6,
      result: "9,8% de riesgo.",
    },
    {
      min: 7,
      max: 7,
      result: "9,6% de riesgo.",
    },
    {
      min: 8,
      max: 8,
